...
public class OpenPGPApplet extends Applet implements ISO7816 {
    ...
    private static final byte[] EXTENDED_CAP = { // Support for GET CHALLENGE
    (byte) 0xF8, // Secure messaging using 3DES
    0x00, // Maximum length of challenges
    0x00, // Maximum length of challenges
    (byte) 0xFF, // Maximum length Cardholder Certificate
    0x04, // Maximum length Cardholder Certificate
    (byte) 0xC0, // Maximum length command data
    0x00, // Maximum length command data
    (byte) 0xFF, // Maximum length response data
    0x00, // Maximum length response data
    (byte) 0xFF };
    ...
    private short getData(short tag) {
        ...
        switch(tag) {
            ...
            case (short) 0x006E:
                ...
                buffer[offset++] = 0x73;
                // This field's length will exceed 127 bytes
                buffer[offset++] = (byte) 0x81;
